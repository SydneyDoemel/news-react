...
export default function Article({ articleInfo, user, savedList, getNews }) {
  ...
  return (
    <div className="card mx-1 mb-4" style={{ width: "20rem" }}>
      <a href={articleInfo.url} className="card-link">
        ...
        <div className="card-footer ">
          <p className="card-text">
            ...
            {published_date.exec(articleInfo.publishedAt)})
          </p>
                  ...
                  <>
                    <form onSubmit={(e) => delArticle(e)}>
                      <button type="submit" className="btn">
                        <BsBookmarkFill className="unsave-btn" size={25} />
                      </button>
                      <input
                        type="hidden"
                        name="delart"
                  ...
                  <>
                    <form onSubmit={(e) => sendArticle(e)}>
                      ...
                      <input
                        type="hidden"
                        name="author"
                        defaultValue={articleInfo.author}
                      />
                      <input
                        type="hidden"
                        name="sourcename"
                        defaultValue={articleInfo.source.name}
                      />
                      <input
                        type="hidden"
                        name="description"
                        defaultValue={articleInfo.description}
                      />
                      <input
                        type="hidden"
                        name="url"
                        defaultValue={articleInfo.url}
                      />
                      <input
                        type="hidden"
                        name="urltoimage"
                        defaultValue={articleInfo.urlToImage}
                      />
                      <input
                        type="hidden"
                        name="publishedat"
                        defaultValue={articleInfo.publishedAt}
                      />
                      <button className="btn big-save-btn" type="submit">
                        <BsBookmark className="save-btn" size={25} />
                      </button>
                    </form>
                  </>
                )}
